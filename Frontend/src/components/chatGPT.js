              ...
              <div className="chatbot-container">
                ...
                <div>
                    <div className="chat-history">
                        ...
                        <div className="response">What are economic sustainability statements?</div>
                        <div className="message">Economic sustainability statements typically refer to a company's disclosure on financial health, contributions, and commitment to sustainable business practices. Often found in sustainability or corporate social responsibility reports, these statements emphasize economic stability while considering social and environmental impacts, aligning with the triple bottom line and global sustainability goals.</div>
                    </div>
                </div>
